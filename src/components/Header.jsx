...
import {isOpen} from '../utils/toggleSideBar.jsx'
  ...
  return (
    <nav className=' flex justify-between py-2 px-6 items-center'>
        <div className='flex gap-6'>
            <img className='w-9 cursor-pointer' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRqsfTQJ5hbaenzuoO4X0sjYVJByQhC4CsRuw&s" alt="menu-icon" onClick={handleSideBar}/>
        ...
        <div className='flex gap-3  border-2 rounded-full border-gray-300'>
            <input className=' outline-none w-[50vh] rounded-l-full px-2 py-1' type="text" placeholder='Search' />
