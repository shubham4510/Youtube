...
const SideBar = () => {
  return (
    <div className=' w-[15%] h-screen  flex flex-col px-3'>
            <h3 className=' font-medium text-xl    mt-2'>Home</h3>
        <ul>
            ...
            <h3 className=' font-medium text-xl cursor-pointer border-b-2 border-gray-300 pb-2   mt-2'>You </h3>
        <ul>
